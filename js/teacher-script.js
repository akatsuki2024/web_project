...
//         const errorElement = $('#employeeid-error'); // Assuming you add an error message container with this ID
...
//         if (isValidPhone && isValidEmployeeID && isPasswordMatch) {
...
//         const isDuplicate = existingTeachers.some(teacher => teacher.username === username);

//         if (isDuplicate) {
//             errorElement.text('Username already exists.').addClass('active');
//             disableRegisterButton();
//         } else {
//             errorElement.removeClass('active');
//             enableRegisterButtonIfValid();

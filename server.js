...
//             // Here, for simplicity, we're assuming that all subjects for semesters III to VI are compulsory.
//             // You can update this logic to differentiate between Compulsory, Department-Level, or Institute-Level subjects.
//             if (!subject.category) {
...
//         // Fetch attendance records for the specific student for the current subject
//         const attendanceRecords = await AttendanceModel.find({
//             'attendance.collegeid': student.collegeid // Only fetch attendance for this student
//         });

//         // Fetch marks records for the specific student
//         const marksRecords = await MarksModel.findOne({
//             collegeID: student.collegeid // Only fetch marks for this student
//         });

//         // Push the fetched records to the arrays if they exist
//         if (attendanceRecords.length > 0) {
//             allAttendanceRecords.push(...attendanceRecords); // Collect all attendance records
//         }

//         if (marksRecords) {
//             allMarksRecords.push(marksRecords); // Collect all marks records
//         }

//         // Remove student attendance data from the collection for the specific subject
//         await AttendanceModel.deleteMany({
//             'attendance.collegeid': student.collegeid // Only delete attendance for this student
//         });

//         // Remove student marks data from the collection for the specific subject
//         await MarksModel.deleteOne({
//             collegeID: student.collegeid // Only delete marks for this student
//         });
//     }
...
// // Helper function to move all student data to the history database
...
//             const historyCollectionName = `std-history-${year}`;
//             const StudentHistoryModel = historyConnection.model(historyCollectionName, studentHistorySchema, historyCollectionName);
